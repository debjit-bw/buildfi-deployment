...
sol! {
    ...
    interface IBuildFi {
        function verificationCallback(address sender, bytes32 claimId, bytes32 postStateDigest, bytes calldata seal);
    }
...
fn prove_and_send_transaction(
    ...
    let calldata = IBuildFi::IBuildFiCalls::verificationCallback(IBuildFi::verificationCallbackCall {
        sender: claims.msg_sender,
